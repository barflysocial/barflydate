...
function intentCompatibility(aIntent, bIntent) {
  ...
  if ((compatible[a] || []).includes(b)) return 14;

  // Do not strongly connect opposite expectations like casual dating and marriage.
  if ((a === "casual_dating" && b === "marriage") || (a === "marriage" && b === "casual_dating")) return -25;
