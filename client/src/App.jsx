...
const APP_VERSION = "BARFLYDATE v100";
...
function BackToHomeButton({ label = "Back to Home" }) {
  return <div className="backHomeRow">
    <Button className="secondary backHomeButton" onClick={() => window.location.href = "/home"}>← {label}</Button>
  </div>;
}
...
function HomePage() {
  ...
  const tiles = [
    ...
    { label: "Games", icon: "🎮", href: "/games", text: "Bingo, trivia, mystery, vote." },
    ...
    { label: "Check In", icon: "🎟️", href: "/checkin", text: "Venue check-in." }
  ];
  ...
  return <div className="screen publicScreen neonPublic homeLauncherPage">
    ...
    <div className="appIconGrid">
      {tiles.map(tile => <button type="button" key={tile.label} className="appIconTile" onClick={() => window.location.href = tile.href}>
...
function GamesDashboard() {
  const settings = usePublicSettings();
  const tools = globalIframeTools(settings);
  return <div className="screen publicScreen neonPublic gamesDashboardPage">
    <PublicBrandHeader />
    <BackToHomeButton />
    <div className="publicHero">
      <div className="brandMark">GAME DASHBOARD</div>
      <h1>Barfly Games</h1>
      <p className="tagline">Bingo, trivia, mystery, and voting live here.</p>
    </div>

    <div className="card neonCard">
      {tools.length ? <GlobalGameIconBar settings={settings} /> : <div className="emptyDayCard">
        <h2>No game links added yet.</h2>
        <p className="muted">Add Bingo, Trivia, Mystery, or Vote iframe URLs in /host → Settings.</p>
      </div>}
    </div>
  </div>;
}
...
function BarflyTVPage() {
  ...
  return <div className="screen publicScreen neonPublic barflyTvPage">
    <PublicBrandHeader />
    <BackToHomeButton />
    <div className="publicHero">
      <div className="brandMark">BARFLY TV</div>
      <h1>Barfly TV</h1>
      <p className="tagline">Video, live content, and featured entertainment.</p>
    </div>

    <div className="card neonCard tvFrameCard">
      {tvUrl ? <iframe src={tvUrl} title="Barfly TV" loading="lazy" scrolling="no" allow="autoplay; fullscreen; picture-in-picture; clipboard-write" /> : <div className="emptyDayCard">
        <h2>Barfly TV is coming soon.</h2>
        <p className="muted">Add a Barfly TV iframe or video URL in /host → Settings.</p>
      </div>}
    </div>
  </div>;
}
...
function SocialWall() {
  ...
  return <div className="screen publicScreen neonPublic socialWallPage">
    ...
    <div className="publicHero socialWallHero">
      ...
      <div className="ctaRow">
        <Button className="secondary" onClick={() => window.location.href = "/home"}>Back to Home</Button>
      </div>
    </div>
  ...
  return <div className="card glowCard hostSettingsPanel" id="host-settings-panel">
    ...
    <div className="promoSettingsBox globalGameSettingsBox">
      ...
      <div className="twoCol">
        ...
        <div className="fullWidth"><label>Barfly TV iframe / video URL</label><input value={settings.barflyTvIframeUrl || ""} onChange={e => update("barflyTvIframeUrl", e.target.value)} placeholder="https://..." /></div>
      </div>
...
function App() {
  ...
  if (parts[0] === "games") return <GamesDashboard />;
