...
const APP_VERSION = "BARFLYDATE v113";
...
function HomePage() {
  ...
  const tiles = [
    ...
    { label: "Karaoke", icon: "🎤", href: karaokeHref, text: "Open Karaoke." },
  ...
  return <div className="screen publicScreen neonPublic homeLauncherPage">
    ...
    <div className="appIconGrid">
      {tiles.filter(tile => tile.href).map(tile => <button type="button" key={tile.label} className="appIconTile homeActionTile" onClick={() => window.location.href = tile.href}>
