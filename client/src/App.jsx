...
const APP_VERSION = "BARFLYDATE v121";
...
function HomePage() {
  ...
  const tiles = [
    ...
    { label: "Bingo", icon: "🎱", href: bingoHref ? "/game/bingo" : "", text: "Open Bingo." },
    { label: "Trivia", icon: "❓", href: triviaHref ? "/game/trivia" : "", text: "Open Trivia." },
    { label: "Mystery", icon: "🕵️", href: mysteryHref ? "/game/mystery" : "/mystery", text: mysteryHref ? "Open Mystery." : "Check back soon." },
    { label: "Escape Room", icon: "🔐", href: escapeRoomHref ? "/game/escape-room" : "/escape-room", text: escapeRoomHref ? "Open Escape Room." : "Check back soon." },
    { label: "Vote", icon: "🗳️", href: voteHref ? "/game/vote" : "", text: "Open Vote." },
    { label: "Karaoke", icon: "🎤", href: karaokeHref || "/karaoke", text: karaokeHref ? "Open Karaoke." : "Upcoming karaoke events." },
