...
const APP_VERSION = "BARFLYDATE v27";
  ...
  return <div className="screen publicScreen neonPublic businessDemo">
    <div className="businessHero">
      ...
      <div className="ctaRow">
        <Button onClick={() => document.getElementById("business-contact")?.scrollIntoView({ behavior: "smooth" })}>Book a Demo</Button>
    ...
    <div id="business-contact" className="card contactCard">
      ...
      <div className="ctaRow">
        <Button onClick={() => window.location.href = "/forecast"}>View Customer Forecast</Button>
