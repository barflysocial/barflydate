...
function PublicBottomActionStack({ showRsvp = false, settings = null }) {
  const fallbackSettings = usePublicSettings();
  const resolvedSettings = settings || fallbackSettings;
  const hasGameTools = globalIframeTools(resolvedSettings).length > 0;
  if (!showRsvp && !hasGameTools) return null;
  return <div className="publicBottomActionStack">
    <GlobalGameIconBar settings={resolvedSettings} />
    {showRsvp && <EventsPageActionNav />}
  </div>;
}
...
const APP_VERSION = "BARFLYDATE v94";
...
function EventsCalendar() {
  ...
  return <div className="screen publicScreen neonPublic eventsPage">
    ...
    <PublicBottomActionStack showRsvp={hasSelectedDateRsvpEvent} settings={settings} />
  </div>;
}
...
function EventDetail() {
  ...
  return <div className="screen publicScreen neonPublic eventDetailPage">
    ...
    <PublicBottomActionStack settings={settings} />
