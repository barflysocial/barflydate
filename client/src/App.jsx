...
const APP_VERSION = "BARFLYDATE v56";
  ...
  return <div className="screen publicScreen neonPublic eventsPage">
    ...
    <div className="card neonCard eventCalendarCard">
      ...
      <div className="calendarViewTabs">
        <Button className={viewMode === "today" ? "" : "secondary"} onClick={() => setCalendarView("today")}>Today</Button>
      ...
      {viewMode === "today" && <div className="todayCalendarPanel">
        <div className="brandMark">TODAY</div>
        <h2>{selectedDateTextFromKey(todayKey)}</h2>
        <p className="muted">Today is shown by default. Tap Week or Month to browse other dates.</p>
      </div>}
