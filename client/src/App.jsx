...
const APP_VERSION = "BARFLYDATE v65";
...
const publicNavItems = [
  ...
  { key: "forecast", label: "Meet & Mingle", icon: "mingleTriad", href: "/radar" },
...
function Join() {
  ...
  return <div className="screen premiumEntry">
    ...
    <div className="row"><Button className="secondary" onClick={() => window.location.href = "/forecast"}>View Meet & Mingle</Button><Button className="secondary" onClick={() => window.location.href = "/rsvp"}>RSVP</Button><Button className="secondary" onClick={() => window.location.href = "/checkin"}>Check In</Button></div>
      ...
      <div className="eventCardGrid">
        {dayEvents.map(event => {
          ...
          return <div className={event.featured ? "card neonCard eventCard premiumEventCard featuredEvent" : "card neonCard eventCard premiumEventCard"} key={event.id}>
            ...
            <div className={`eventTemplateHero template-${template?.slug || "game-night"}`} style={templateHeroStyle(template)} aria-label={`${typeLabel} event art`}>
              {!template?.backgroundImageUrl && <div className="eventTemplateFallback">{typeLabel}</div>}
            </div>
...
function HostSection({ title, subtitle, children }) {
  return <details className="hostSection">
    <summary>
      <div>
...
function HostQuickActions() {
  ...
  return <div className="card glowCard hostQuickActions" id="host-quick-actions">
    ...
    <div className="quickActionGrid">
      <Button onClick={() => jump("host-poster-builder")}>Poster Builder</Button>
      <Button className="secondary" onClick={() => jump("host-events")}>Add Event</Button>
...
function Forecast() {
  ...
  return <div className="screen publicScreen neonPublic">
    <div className="publicHero">
      ...
      <h1>Meet & Mingle</h1>
      <p className="tagline">See where your kind of crowd is gathering. See where your kind of crowd is gathering and connect with the right vibe.</p>
...
function HostManager() {
  ...
  return <div className="screen hostManagerCompact">
    ...
    <HostSection title="Gameplay" subtitle="Create sessions, test games, active games, and run-of-show.">
    ...
    <HostSection title="Events & Calendar" subtitle="Event calendar, booking calendar, booking list, and event editor.">
      <HostEventCalendar />
      <HostBookingCalendar />
      <HostBookingsPanel />
      <HostEventsPanel />
    ...
    <HostSection title="Marketing" subtitle="Poster Builder, event templates, QR tools, and promo assets.">
      <PosterBuilder />
      <HostTemplateManager />
      <div className="card glowCard">
    ...
    <HostSection title="Business" subtitle="Venue partners, analytics, and backup/export tools.">
      <HostVenueManager />
    ...
    <HostSection title="Settings" subtitle="Host and public app settings.">
      <HostSettingsPanel />
    </HostSection>
  </div>;
}
