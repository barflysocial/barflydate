...
const APP_VERSION = "BARFLYDATE v34";
  ...
  return <div className="screen publicScreen neonPublic businessDemo">
    ...
    <div id="business-contact" className="card contactCard">
      ...
      <div className="contactGrid">
        ...
        <div><span>Website</span><b>{settings.website || BUSINESS_WEBSITE}</b></div>
        <div><span>Games</span><b>{settings.gamesSite || BUSINESS_GAMES_SITE}</b></div>
        <div><span>Booking</span><b>{settings.bookingLink || BUSINESS_BOOKING_LINK}</b></div>
      </div>
...
function HostSettingsPanel() {
  ...
  return <div className="card glowCard hostSettingsPanel">
    ...
    <div className="twoCol">
      ...
      <div><label>Booking Link</label><input value={settings.bookingLink} onChange={e => update("bookingLink", e.target.value)} /></div>
      <div><label>Website</label><input value={settings.website} onChange={e => update("website", e.target.value)} /></div>
      <div><label>Games Site</label><input value={settings.gamesSite} onChange={e => update("gamesSite", e.target.value)} /></div>
      <div><label>Instagram Handle</label><input value={settings.instagramHandle} onChange={e => update("instagramHandle", e.target.value)} /></div>
    </div>
