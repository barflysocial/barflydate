...
const onlineEventTypes = ["bingo", "trivia", "music_bingo", "mystery"];
...
const APP_VERSION = "BARFLYDATE v45";
  ...
  return <div className={`screen splashScreen ${ready ? "fadeOut" : ""}`}>
    ...
    <div className="splashCenter">
      <div className="logoWrap">
        ...
        <img src="/brand/barfly-social-dragonfly.png" alt="Barfly Social" className="splashLogo" />
      </div>
...
function HostTemplateManager() {
  ...
  return <div className="card glowCard hostTemplateManager" id="host-templates">
    ...
    {templates.map(template => <div className="rsvpRow" key={template.id}>
      <div>
        <b>{template.name}</b>
        <p className="muted">{eventTypeCalendarLabel(template.eventType)} • {template.buttonText} → {template.buttonLink}</p>
...
function BusinessDemo() {
  ...
  return <div className="screen publicScreen neonPublic businessDemo">
    ...
    <div id="business-contact" className="card contactCard">
      ...
      <div className="contactGrid contactMiniGrid">
        <div><span>Contact</span><b>Desmon LeJeune</b></div>
        <div><span>Phone</span><b>{settings.businessPhone || BUSINESS_PHONE}</b></div>
        <div><span>Email</span><b>{settings.businessEmail || BUSINESS_EMAIL}</b></div>
      </div>
...
function HostEventsPanel() {
  ...
  return <div className="card glowCard hostEventsPanel" id="host-events">
    ...
    <div className="primaryActionPreview">Public button preview: <b>{form.buttonText || (form.eventType === "barfly_social" ? "View Forecast / RSVP" : form.onlineOnly ? "Play Now" : "More Info")}</b></div>
