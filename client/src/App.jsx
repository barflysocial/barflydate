...
const APP_VERSION = "BARFLYDATE v61";
...
function PosterBuilder() {
  ...
  const template = posterTemplates.find(item => item.slug === form.templateSlug) || posterTemplates[0];
  ...
  return <div className="card glowCard posterBuilder" id="host-poster-builder">
    ...
    <p className="muted">Build reusable Instagram promos. The theme background stays generic while event details are overlaid by the system.</p>
    ...
    <div className="posterBuilderGrid">
      <div className="posterBuilderForm">
        ...
        <div className="twoCol">
          <div><label>Template</label><select value={form.templateSlug} onChange={e => {
            const selected = posterTemplates.find(item => item.slug === e.target.value);
      ...
      <div className="posterBuilderPreview">
        ...
        <p className="microcopy">Preview uses system overlay text. Background art stays reusable and clean.</p>
      </div>
    </div>
  </div>;
}
