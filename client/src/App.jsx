...
const APP_VERSION = "BARFLYDATE v77";
      ...
      <div className="wizardStep">
        ...
        <div>
          ...
          <div className="heroGraphicPreviewWindow">
            ...
            <div className={heroPreviewUrl ? "heroGraphicPreview hasImage" : "heroGraphicPreview"} style={heroPreviewUrl ? { backgroundImage: `linear-gradient(180deg, rgba(0,0,0,.08), rgba(0,0,0,.34)), url(${heroPreviewUrl})` } : undefined}>
            ...
            <p className="microcopy">This is the 4:5 hero area used on the event card. Use 1080×1350 or 2160×2700 hero graphics.</p>
          </div>
        </div>
      </div>
