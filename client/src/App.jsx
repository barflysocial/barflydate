...
const APP_VERSION = "BARFLYDATE v25";
...
function SplashScreen() {
  ...
  return <div className={ready ? "splashScreen splashExit" : "splashScreen"}>
    ...
    <div className="splashText">
      ...
      <p>{ready ? "Opening forecast..." : "Loading nearby sessions..."}</p>
    </div>
...
function HostManager() {
  ...
  async function createGame() {
    const res = await fetch(`${API}/games`, {
      ...
      body: JSON.stringify({ venueName, venueLocation, drinkSpecialTitle, drinkSpecialDetails, drinkSpecialWindow, drinkSpecialRestrictions, meetingPointMode, meetingZones, gameMode, maxRsvps, maxCheckins })
    });
    const data = await res.json();
