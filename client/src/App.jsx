...
function eventPrimaryAction(event) {
  ...
  return {
    label: eventUnavailable(event)
      ...
      : (event?.buttonText || (isBarflySocial ? "View Forecast / RSVP" : isOnline ? "Play Now" : "More Info")),
...
const APP_VERSION = "BARFLYDATE v49";
  ...
  return <div className="screen publicScreen neonPublic eventsPage">
    <div className="publicHero eventsHeroCompact">
      <div className="ctaRow">
        ...
        <Button className="secondary" onClick={() => window.location.href = "/forecast"}>Barfly Social Forecast</Button>
    ...
    {featuredEvent && <div className="card neonCard featuredEventBanner">
      ...
      <div>
        ...
        <div className="ctaRow">
          ...
          <Button className="secondary" onClick={() => window.location.href = featuredEvent.publicPath}>Event Page</Button>
          <Button className="secondary" onClick={() => copyEventCaption(featuredEvent, settings)}>Copy Caption</Button>
        </div>
      </div>
    </div>}
...
function HostEventsPanel() {
  ...
  return <div className="card glowCard hostEventsPanel" id="host-events">
    ...
    <div className="primaryActionPreview">Public button preview: <b>{form.buttonText || (form.eventType === "barfly_social" ? "View Forecast / RSVP" : form.eventType === "escape_room" ? "Start Escape Room" : form.eventType === "mystery" ? "Start Mystery" : form.onlineOnly ? "Play Now" : "More Info")}</b></div>
