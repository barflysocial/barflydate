...
const APP_VERSION = "BARFLYDATE v78";
...
function HostQuickActions() {
  ...
  return <div className="card glowCard hostQuickActions" id="host-quick-actions">
    ...
    <div className="quickActionGrid">
      ...
      <Button className="secondary" onClick={() => openSection("host-section-gameplay", "create-social-session")}>Quick Create Meet & Mingle Session</Button>
