...
const APP_VERSION = "BARFLYDATE v110";
...
function HomePage() {
  ...
  return <div className="screen publicScreen neonPublic homeLauncherPage">
    ...
    <div className="appIconGrid">
      {tiles.map(tile => <button type="button" key={tile.label} className="appIconTile homeActionTile" onClick={() => window.location.href = tile.href}>
