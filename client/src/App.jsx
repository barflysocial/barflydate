...
const APP_VERSION = "BARFLYDATE v116";
...
function KaraokePage() {
  ...
  if (karaokeUrl) return <div className="screen publicScreen neonPublic karaokeFallbackPage">
    <div className="card neonCard karaokeCalendarBox">
  ...
  return <div className="screen publicScreen neonPublic karaokeFallbackPage">
    <div className="card neonCard karaokeCalendarBox">
      <div className="brandMark">KARAOKE</div>
      <h1>Check the calendar for upcoming karaoke events.</h1>
      <p className="muted">No karaoke link is active right now.</p>
      <div className="ctaRow">
