...
const APP_VERSION = "BARFLYDATE v81";
...
function HostEventsPanel() {
  ...
  return <div className="card glowCard hostEventsPanel" id="host-events">
          ...
          <div className="heroGraphicPreviewWindow">
            ...
            {form.showHeroGraphic === false ? <div className="heroGraphicPreview noHeroPreview">
              <div>
                ...
                <p>{form.venueName || "Venue"} • {heroVariantLabel(form.heroVariant)}</p>
              </div>
    ...
    <details className="advancedEventDetails">
      ...
      <div><label>Hero Image URL</label><input value={form.heroImageUrl} disabled={form.showHeroGraphic === false} onChange={e => update("heroImageUrl", e.target.value)} placeholder="Auto-filled from Venue + Hero Variant" /><Button className="secondary miniButton" onClick={applyMatchingHero} disabled={form.showHeroGraphic === false}>Use Matching Venue Hero</Button>{form.showHeroGraphic === false && <p className="microcopy">No Hero Graphic is selected.</p>}{heroUrlWarning(form.heroImageUrl) && <p className="warningText">{heroUrlWarning(form.heroImageUrl)}</p>}</div>
