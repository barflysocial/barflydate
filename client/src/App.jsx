...
const APP_VERSION = "BARFLYDATE v82";
    ...
    <div className="card quickEventBuilder">
      ...
      <div className="wizardStep">
        ...
        <div>
          ...
          <div className="twoCol">
            ...
            <div><label>Venue Logo URL</label><input value={form.venueLogoUrl} onChange={e => update("venueLogoUrl", e.target.value)} placeholder="/logos/venue.png" /></div>
      ...
      <div><label>Hero Variant</label><select value={form.heroVariant} onChange={e => update("heroVariant", e.target.value)}>
          ...
          <div className="heroSuggestion">
            {suggestedHeroUrl ? <><b>Recommended hero found</b><p>{form.venueName} + {heroVariantLabel(form.heroVariant)}</p><Button className="secondary" onClick={useSuggestedHero}>Use This Hero</Button></> : <><b>No saved hero match yet</b><p>Choose a saved hero below, paste a Hero Image URL in Advanced, or select No Hero Graphic.</p></>}
          </div>
