# BARFLYDATE_v29_20260427_0309

Complete full ZIP build. No patches.

## New in v29 — Barfly Events Calendar
Built from v28.
...
The host dashboard now includes a Barfly Events Calendar panel.
...
- QR pages
- Duplicate session
- Better RSVP onboarding copy
- Sales walkthrough
- Post-event business report
- Splash page
- RSVP-only flow
- Capacity tools
- Meeting zones
...
# BARFLYDATE_v28_20260427_0256

Complete full ZIP build. No patches.

## New in v28 — Business Launch Tools
Built from v27.

### Included
1. Booking link and business contact placeholders in `client/src/App.jsx`
2. Built-in QR display pages:
   - `/qr/forecast`
   - `/qr/business-demo`
   - `/qr/checkin`
   - `/qr/host`
   - `/qr/events`
3. Duplicate Last Session on host dashboard
4. Better player RSVP onboarding copy
5. Sales walkthrough mode on `/business-demo`
6. Post-event business report at `/host/:gameId/report`
...
- No-shows
- Capacity used
- Drink special promoted
- Safety reports
- Rounds completed
- Pairings created
- Mutual sparks created
- Intent breakdown

## Deployment note
This ZIP is Render-ready. `package.json`, `client/`, `server/`, and `render.yaml` are at the ZIP root.

# BARFLYDATE_v27_20260427_0013

Complete full ZIP build. No patches.

## New in v27 — Business Demo + Venue Sales Page
Built from v26.
...
### Business demo includes
- Barfly Social venue-facing pitch
- How it works section
- Venue benefits section
- Venue drink special example
- Simulated app screen cards
- Event type examples
- Mock host dashboard metrics
- Contact / booking section for Barfly Entertainment

### Important routing
- `/` still shows the Barfly Social splash screen first, then goes to `/forecast`
- `/business-demo` opens directly without requiring the splash screen
- `/forecast` remains the customer public flow
- `/host` remains PIN-protected host flow

### Preserved from v26
- Event type selection
- Smarter matchmaking
- Host Event Mode
- Player next-move screen
- No-show handling
- Splash screen
- RSVP-only flow
- Capacity tools
...
# BARFLYDATE_v26_20260426_2346

Complete full ZIP build. No patches.

## New in v26
Built from v25 and implements the requested upgrades:
...
### 2. Smarter matchmaking
The matching engine now scores:
- mutual gender preference
- intent compatibility
- age range overlap
- shared interests
- positive prior signals
- no repeat pairings
- no rematch after reports
- no rematch after mutual skips

### 3. Host Event Mode screen
New route:
`/host/:gameId/event`

Shows a simplified live control screen:
- checked-in count
- RSVP count
- open safety reports
- current phase
...
### 4. Player next-move screen
During breaks, players see:
- next partner if ready
- next meeting zone
- next topic
...
### 5. No-show handling
Host can:
- mark an individual RSVP as no-show
- mark all open RSVPs as no-show
- view no-show count in exports

### Preserved from v25
- Barfly Social splash screen
- Meeting zones
